...
class DrawsController extends Controller
{
    ...
    /**
     * Updates an existing Draws model.
    ...
    /**
     * Deletes an existing Draws model.
    ...
    /**
     * Finds the Draws model based on its primary key value.
